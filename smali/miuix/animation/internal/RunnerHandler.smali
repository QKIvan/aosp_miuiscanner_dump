...
.method private runAnim(JJZ)V
    ...
    .line 326
    iget-object v1, v0, Lmiuix/animation/internal/RunnerHandler;->runningTarget:Ljava/util/Set;
    ...
    .line 330
    iput-wide v1, v0, Lmiuix/animation/internal/RunnerHandler;->mLastRun:J
    ...
    .line 332
    iget v3, v0, Lmiuix/animation/internal/RunnerHandler;->mFrameCount:I
    ...
    .line 335
    :goto_0
    iget-wide v5, v0, Lmiuix/animation/internal/RunnerHandler;->mTotalT:J

    add-long/2addr v5, v1

    iput-wide v5, v0, Lmiuix/animation/internal/RunnerHandler;->mTotalT:J

    add-int/2addr v3, v4

    .line 336
    iput v3, v0, Lmiuix/animation/internal/RunnerHandler;->mFrameCount:I
    ...
    .line 338
    iget-object v5, v0, Lmiuix/animation/internal/RunnerHandler;->mSplitInfo:[I

    invoke-static {v3, v5}, Lmiuix/animation/internal/ThreadPoolUtil;->getSplitCount(I[I)V

    .line 339
    iget-object v3, v0, Lmiuix/animation/internal/RunnerHandler;->mSplitInfo:[I
    ...
    .line 341
    iget-object v6, v0, Lmiuix/animation/internal/RunnerHandler;->runningTarget:Ljava/util/Set;
    ...
    check-cast v7, Lmiuix/animation/IAnimTarget;

    .line 342
    iget-object v7, v7, Lmiuix/animation/IAnimTarget;->animManager:Lmiuix/animation/internal/AnimManager;

    iget-object v8, v0, Lmiuix/animation/internal/RunnerHandler;->mTransList:Ljava/util/List;

    invoke-virtual {v7, v8}, Lmiuix/animation/internal/AnimManager;->getTransitionInfos(Ljava/util/List;)V

    goto :goto_1

    .line 344
    :cond_2
    iget-object v6, v0, Lmiuix/animation/internal/RunnerHandler;->mTransList:Ljava/util/List;

    invoke-direct {p0, v6, v3, v5}, Lmiuix/animation/internal/RunnerHandler;->addAnimTask(Ljava/util/List;II)V

    .line 345
    iget-object v3, v0, Lmiuix/animation/internal/RunnerHandler;->mTaskList:Ljava/util/List;
    ...
    iput-boolean v3, v0, Lmiuix/animation/internal/RunnerHandler;->mIsTaskRunning:Z

    .line 346
    sget-object v3, Lmiuix/animation/internal/AnimTask;->sTaskCount:Ljava/util/concurrent/atomic/AtomicInteger;

    iget-object v4, v0, Lmiuix/animation/internal/RunnerHandler;->mTaskList:Ljava/util/List;
    ...
    check-cast v8, Lmiuix/animation/internal/AnimTask;

    .line 348
    iget-wide v9, v0, Lmiuix/animation/internal/RunnerHandler;->mTotalT:J

    move-wide v11, v1

    move/from16 v13, p5

    invoke-virtual/range {v8 .. v13}, Lmiuix/animation/internal/AnimTask;->start(JJZ)V

    goto :goto_2

    .line 350
    :cond_3
    iget-object v1, v0, Lmiuix/animation/internal/RunnerHandler;->mTransList:Ljava/util/List;

    invoke-interface {v1}, Ljava/util/List;->clear()V

    .line 351
    iget-object v1, v0, Lmiuix/animation/internal/RunnerHandler;->mTaskList:Ljava/util/List;

...
.method private constructFromFile(Ljava/lang/String;)V
    ...
    invoke-interface {v1}, Lmiuix/core/util/DirectIndexedFile$InputFile;->readInt()I
...
.method public declared-synchronized get(III)Ljava/lang/Object;
    ...
    invoke-interface {p2}, Lmiuix/core/util/DirectIndexedFile$InputFile;->readLong()J
    ...
    invoke-interface {p2}, Lmiuix/core/util/DirectIndexedFile$InputFile;->readInt()I
    ...
    invoke-interface {p2}, Lmiuix/core/util/DirectIndexedFile$InputFile;->readShort()S
    ...
    invoke-interface {p2}, Lmiuix/core/util/DirectIndexedFile$InputFile;->readByte()B
    ...
    .line 963
    invoke-direct {p0, p1, p3, v1}, Lmiuix/core/util/DirectIndexedFile$Reader;->readSingleDataItem(III)Ljava/lang/Object;
...
.method public declared-synchronized get(II)[Ljava/lang/Object;
    ...
    invoke-interface {v0}, Lmiuix/core/util/DirectIndexedFile$InputFile;->readLong()J
    ...
    invoke-interface {v0}, Lmiuix/core/util/DirectIndexedFile$InputFile;->readInt()I
    ...
    invoke-interface {v0}, Lmiuix/core/util/DirectIndexedFile$InputFile;->readShort()S
    ...
    invoke-interface {v0}, Lmiuix/core/util/DirectIndexedFile$InputFile;->readByte()B
    ...
    invoke-interface {v0}, Lmiuix/core/util/DirectIndexedFile$InputFile;->getFilePointer()J

    move-result-wide v3

    .line 1038
    invoke-direct {p0, p1, v5, v1}, Lmiuix/core/util/DirectIndexedFile$Reader;->readSingleDataItem(III)Ljava/lang/Object;
    ...
    invoke-interface {v0, v3, v4}, Lmiuix/core/util/DirectIndexedFile$InputFile;->seek(J)V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
